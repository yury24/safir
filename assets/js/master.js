// CUSTOM CODE FOR FILTERS AND TEXT
jQuery(document).ready(function ($) {
	// FILTER OPTIONS
	const allFilter = $('#all-filter');
	const avinocFilter = $('#avinoc-filter');
	const ifibrFilter = $('#ifibr-filter');
	const tupanFilter = $('#tupan-filter');
	const zeniqFilter = $('#zeniq-filter');

	// TEXT OPTIONS
	const allText = $('#all-text');
	const avinocText = $('#avinoc-text');
	const ifibrText = $('#ifibr-text');
	const tupanText = $('#tupan-text');
	const zeniqText = $('#zeniq-text');

	allFilter.click(function() {
		allText.css('display', 'block');
		avinocText.css('display', 'none');
		ifibrText.css('display', 'none');
		tupanText.css('display', 'none');
		zeniqText.css('display', 'none');
	});

	avinocFilter.click(function() {
		allText.css('display', 'none');
		avinocText.css('display', 'block');
		ifibrText.css('display', 'none');
		tupanText.css('display', 'none');
		zeniqText.css('display', 'none');
	});

	ifibrFilter.click(function() {
		allText.css('display', 'none');
		avinocText.css('display', 'none');
		ifibrText.css('display', 'block');
		tupanText.css('display', 'none');
		zeniqText.css('display', 'none');
	});

	tupanFilter.click(function() {
		allText.css('display', 'none');
		avinocText.css('display', 'none');
		ifibrText.css('display', 'none');
		tupanText.css('display', 'block');
		zeniqText.css('display', 'none');
	});

	zeniqFilter.click(function() {
		allText.css('display', 'none');
		avinocText.css('display', 'none');
		ifibrText.css('display', 'none');
		tupanText.css('display', 'none');
		zeniqText.css('display', 'block');
	});
});

// CUSTOM SLIDER LOGIC

// END OF CUSTOM SLIDER LOGIC
